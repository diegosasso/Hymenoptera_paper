...
#-----
min(tip.total.changes)
max(tip.total.changes)
...
colMeans(tip.prop.enriched) %>% max()
colMeans(tip.prop.enriched) %>% min()
...
colMeans(enriched_time_prop) %>% max()
colMeans(enriched_time_prop) %>% min()
